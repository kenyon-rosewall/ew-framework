...
<div id="content" class="welcome-box"><?php echo $content_top; ?>
  ...
  <div class="buttons">
  	...
  	<?php if( ((date('N')==6) && (date('H') > 19 || date('H') < 7 || (date('H') == 18 && date('i') > 30) )) || 
  			  ((date('N')==7) && (date('H') > 15 || date('H') < 7 || (date('H') == 14 && date('i') > 30) )) || 
  			  ((date('N') < 6 && date('N') > 0) && (date('H') > 20 || date('H') < 7 || (date('H') == 19 && date('i') > 30) )) ): ?>
  	We are sorry, but we are not accepting orders at this time.
  	<?php else: ?>
